 ...
 * mail@ionflux.org
 * --------------------------------------------------------------------------
 * msgclient.cpp                  Message based TCP client test.
 * ==========================================================================
 * 
...
int main(int argc, char* argv[])
{
	...
	TCPMessageClient client(true);
	signal(SIGINT, TCPMessageClient::shutdownHandler);
	signal(SIGTERM, TCPMessageClient::shutdownHandler);
