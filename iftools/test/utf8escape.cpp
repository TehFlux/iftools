 ...
 * mail@ionflux.org
 * --------------------------------------------------------------------------
 * utf8escape.cpp                  UTF-8 escaping test.
 * ==========================================================================
 * 
...
void printHelp()
{
	cout << "Usage: utf8escape [<option> ...] <input>\n"
		"Options:\n"
...
void printVersion()
{
	cout << "utf8escape " << Ionflux::Tools::MODULE_VERSION << " (" 
...
int main(int argc, char* argv[])
{
	...
	cout << utf8Escape(params[0]) << endl;
	return 0;
}

/** \file utf8escape.cpp
 * \brief UTF-8 escaping test.
 */
