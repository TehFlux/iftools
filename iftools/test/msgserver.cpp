 ...
 * mail@ionflux.org
 * --------------------------------------------------------------------------
 * msgserver.cpp                  Message based TCP server test.
 * ==========================================================================
 * 
...
int main(int argc, char* argv[])
{
	...
	if (option == 0)
	{
		cout << "Usage: msgserver -p <port> [-m <maxClients>]" << endl;
		return 0;
	}
	...
	signal(SIGINT, TCPMessageServer::shutdownHandler);
	signal(SIGTERM, TCPMessageServer::shutdownHandler);
...
/** \file msgserver.cpp
 * \brief Message based TCP server test.
 */
