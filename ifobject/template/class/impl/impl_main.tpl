...
# 
# ==========================================================================
{import class.check_features}{ref checkFeatures}{import class.insert_gpl_disclaimer}{section insertIncludeBlocks}{foreach block in includeBlock}{if ( block.pos == includeBlockPos ) && ( block.file == includeBlockFile )}{if block.type == "list"}{foreach inc in block.list}
