...
# 
# ==========================================================================
{import class.check_features}{ref checkFeatures}{import class.insert_gpl_disclaimer}{import class.header.insert_includes}{import class.header.insert_forwards}{import class.header.insert_typedefs}{import class.header.create_struct_decl}{import class.header.create_event_helper_function_decl}{import class.header.declare_global_func}{import class.header.declare_class_name_funcs}{import class.header.property.declare_property_set_funcs}{import class.header.property.declare_property_clear_func}{import class.header.accessor.declare_extended_vector_add_funcs}{import class.header.accessor.declare_vector_write_funcs}{import class.header.accessor.declare_map_write_funcs}{import class.header.accessor.declare_property_write_funcs}{import class.header.accessor.declare_vector_read_funcs}{import class.header.accessor.declare_map_read_funcs}{import class.header.accessor.declare_property_read_funcs}{import class.header.persistence.declare_persistent_init_func}{import class.header.persistence.declare_persistence_funcs}{import class.header.persistence.declare_persistent_protected_funcs}{import class.header.declare_copy_funcs}{import class.header.declare_upcast_funcs}{import class.header.declare_extended_create_funcs}{import class.header.declare_create_funcs}{import class.header.declare_param_funcs}{import class.header.declare_func}{import class.header.qt.declare_qt_signal}{import class.header.qt.declare_qt_slot}{import class.header.project_info}{ref projectInfo}
