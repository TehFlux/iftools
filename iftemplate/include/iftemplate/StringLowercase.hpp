#ifndef IONFLUX_TEMPLATE_STRINGLOWERCASE
#define IONFLUX_TEMPLATE_STRINGLOWERCASE
/* ==========================================================================
 * IFTemplate - Ionflux Template Processor
 * Copyright © 2012 Jörn P. Meier
 * mail@ionflux.org
 * --------------------------------------------------------------------------
 * StringLowercase.hpp             String manipulator: lowercase (header).
 * =========================================================================
 * 
...
/// Class information for class StringLowercase.
 ...
 * \ingroup iftemplate
 *
 * String manipulator that converts a string (or a part of it) to its 
...
: virtual public Ionflux::Template::StringManipulator::StringManipulator
{
	...
	public:
		...
		static const StringLowercaseClassInfo stringLowercaseClassInfo;
		/// Class information.
		static const Ionflux::ObjectBase::IFClassInfo* CLASS_INFO;
		
		/** Constructor.
		 *
		 * Construct new StringLowercase object.
		 */
		StringLowercase();
		...
		/** Destructor.
		 *
		 * Destruct StringLowercase object.
		 */
		 ...
		 */
		virtual Ionflux::Template::StringManipulator::StringLowercase& 
		operator=(const Ionflux::Template::StringManipulator::StringLowercase& 
		other);
 ...
 * \brief String manipulator: lowercase (header).
 */
#endif
