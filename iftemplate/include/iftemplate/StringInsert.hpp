#ifndef IONFLUX_TEMPLATE_STRINGINSERT
#define IONFLUX_TEMPLATE_STRINGINSERT
/* ==========================================================================
...
/// Class information for class StringInsert.
 ...
 * \ingroup iftemplate
 *
 * String manipulator that inserts a string.
 * 
 * insert(s, p)
 * s - String to insert
...
: virtual public Ionflux::Template::StringManipulator::StringManipulator
{
	...
	public:
		...
		static const StringInsertClassInfo stringInsertClassInfo;
		/// Class information.
		static const Ionflux::ObjectBase::IFClassInfo* CLASS_INFO;
		
		/** Constructor.
		 *
		 * Construct new StringInsert object.
		 */
		StringInsert();
		 ...
		 */
		virtual Ionflux::Template::StringManipulator::StringInsert& 
		operator=(const Ionflux::Template::StringManipulator::StringInsert& 
		other);
...
/** \file StringInsert.hpp
 * \brief String manipulator: insert (header).
 */
#endif
